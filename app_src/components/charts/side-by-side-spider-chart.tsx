...
interface SideBySideSpiderChartProps {
    primaryData: { [model: string]: { [dimension: string]: number } }
...
export function SideBySideSpiderChart({
    primaryData,
    humanData,
    selectedModels,
    selectedDimensions,
    ...
    useEffect(() => {
        createSpiderChart(primarySvgRef, primaryData, primaryTitle)
        createSpiderChart(humanSvgRef, humanData, humanTitle)
    }, [primaryData, humanData, selectedModels, selectedDimensions, primaryTitle, humanTitle])

    return (
        <div className="flex justify-center gap-8 items-start">
            {/* Primary Chart */}
            <div className="flex-shrink-0">
                <svg ref={primarySvgRef} className="border rounded-lg bg-white" />
            </div>
