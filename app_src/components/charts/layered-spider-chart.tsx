...
interface LayeredSpiderChartProps {
...
export function LayeredSpiderChart({ autoData, llmData, selectedModels, selectedDimensions }: LayeredSpiderChartProps) {
    ...
    useEffect(() => {
        ...
        svg
            ...
            .attr("font-weight", "bold")
            .attr("fill", "#1f2937")
            .text("Auto vs LLM Annotations - Layered Spider Plot")
    }, [autoData, llmData, selectedModels, selectedDimensions, colorScale])
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        {selectedModels.map((model, i) => {
                            const color = colorScale(i.toString()) // Use the same color scale instance
                            return (
